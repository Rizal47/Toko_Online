            ...
            <li class="nav-item">
                ...
                <div id="collapseNol" class="collapse" aria-labelledby="headingNol" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="-.php">Pakaian</a>
                        <a class="collapse-item" href="-.php">Aksesoris</a>
                    </div>
                </div>
            </li>
        <?php
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <section class="mar-top--x-3 mar-bottom--x-5">
                    <div class="container">
                        <center>
                            <h1 class="h3 mb-0 text-gray-800">SELAMAT DATANG DI toko</h1>
                        </center>
                    </div>
                    <br>
                    <div class="container">      
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/1.png" class="d-block w-100" alt="gambar">
                            </div>
                            <div class="carousel-item">
                                <img src="img/2.png" class="d-block w-100" alt="gambar">
                            </div>
                        </div>
